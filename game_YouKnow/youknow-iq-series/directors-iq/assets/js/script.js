...
function finishGame() {
    ...
    if(scorePct < 30) {
        document.querySelector('.scoreText1').innerHTML = 'Pior dos piores!';
        document.querySelector('.scorePct').style.color = "#FF0000";
        document.querySelector('.prizeImage').src = "assets/img/img-winner/framboesa.jpg";
    } else if (scorePct >=30 && scorePct < 50){
        document.querySelector('.scoreText1').innerHTML = 'Trofeu imprensa!';
        document.querySelector('.scorePct').style.color = "#FF9900";
        document.querySelector('.prizeImage').src = "assets/img/img-winner/imprensa.jpg";
        ...
        document.querySelector('.prizeImage').src = "assets/img/img-winner/absolute-cinema.jpg";        
    }
    
    document.querySelector('.scorePct').textContent = `Acertou ${scorePct}%`;
    document.querySelector('.scoreText2').textContent = 
        `De ${totalQuestions} diretores de cinema, você conhece ${correctAnswers}`;
